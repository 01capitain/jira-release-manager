export type ColorClasses = { light: string; dark: string; text: string };

// Central color map at module scope to avoid re-creation per call.
const MAP = {
  slate: {
    light: "bg-slate-100",
...
export type ColorBase = keyof typeof MAP;
