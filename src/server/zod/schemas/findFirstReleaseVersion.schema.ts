...
export const ReleaseVersionFindFirstSelectSchema: z.ZodType<Prisma.ReleaseVersionSelect> = z.object({
...
export const ReleaseVersionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
...
export const ReleaseVersionFindFirstSchema: z.ZodType<Prisma.ReleaseVersionFindFirstArgs> = z.object({ select: ReleaseVersionFindFirstSelectSchema.optional(), include: z.lazy(() => ReleaseVersionIncludeObjectSchema.optional()), orderBy: z.union([ReleaseVersionOrderByWithRelationInputObjectSchema, ReleaseVersionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReleaseVersionWhereInputObjectSchema.optional(), cursor: ReleaseVersionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReleaseVersionScalarFieldEnumSchema, ReleaseVersionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ReleaseVersionFindFirstArgs>;

export const ReleaseVersionFindFirstZodSchema = z.object({ select: ReleaseVersionFindFirstSelectSchema.optional(), include: z.lazy(() => ReleaseVersionIncludeObjectSchema.optional()), orderBy: z.union([ReleaseVersionOrderByWithRelationInputObjectSchema, ReleaseVersionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReleaseVersionWhereInputObjectSchema.optional(), cursor: ReleaseVersionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReleaseVersionScalarFieldEnumSchema, ReleaseVersionScalarFieldEnumSchema.array()]).optional() }).strict();