...
export const ReleaseVersionFindManySelectSchema: z.ZodType<Prisma.ReleaseVersionSelect> = z.object({
...
export const ReleaseVersionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
...
export const ReleaseVersionFindManySchema: z.ZodType<Prisma.ReleaseVersionFindManyArgs> = z.object({ select: ReleaseVersionFindManySelectSchema.optional(), include: z.lazy(() => ReleaseVersionIncludeObjectSchema.optional()), orderBy: z.union([ReleaseVersionOrderByWithRelationInputObjectSchema, ReleaseVersionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReleaseVersionWhereInputObjectSchema.optional(), cursor: ReleaseVersionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReleaseVersionScalarFieldEnumSchema, ReleaseVersionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ReleaseVersionFindManyArgs>;

export const ReleaseVersionFindManyZodSchema = z.object({ select: ReleaseVersionFindManySelectSchema.optional(), include: z.lazy(() => ReleaseVersionIncludeObjectSchema.optional()), orderBy: z.union([ReleaseVersionOrderByWithRelationInputObjectSchema, ReleaseVersionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReleaseVersionWhereInputObjectSchema.optional(), cursor: ReleaseVersionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReleaseVersionScalarFieldEnumSchema, ReleaseVersionScalarFieldEnumSchema.array()]).optional() }).strict();