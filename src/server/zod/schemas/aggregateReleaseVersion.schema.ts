...
export const ReleaseVersionAggregateSchema: z.ZodType<Prisma.ReleaseVersionAggregateArgs> = z.object({ orderBy: z.union([ReleaseVersionOrderByWithRelationInputObjectSchema, ReleaseVersionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReleaseVersionWhereInputObjectSchema.optional(), cursor: ReleaseVersionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), _count: z.union([ z.literal(true), ReleaseVersionCountAggregateInputObjectSchema ]).optional(), _min: ReleaseVersionMinAggregateInputObjectSchema.optional(), _max: ReleaseVersionMaxAggregateInputObjectSchema.optional() }).strict() as unknown as z.ZodType<Prisma.ReleaseVersionAggregateArgs>;

export const ReleaseVersionAggregateZodSchema = z.object({ orderBy: z.union([ReleaseVersionOrderByWithRelationInputObjectSchema, ReleaseVersionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReleaseVersionWhereInputObjectSchema.optional(), cursor: ReleaseVersionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), _count: z.union([ z.literal(true), ReleaseVersionCountAggregateInputObjectSchema ]).optional(), _min: ReleaseVersionMinAggregateInputObjectSchema.optional(), _max: ReleaseVersionMaxAggregateInputObjectSchema.optional() }).strict();