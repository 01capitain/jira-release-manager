...
export const ReleaseVersionFindUniqueSchema: z.ZodType<Prisma.ReleaseVersionFindUniqueArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.ReleaseVersionFindUniqueArgs>;

export const ReleaseVersionFindUniqueZodSchema = z
  .object({
    select: ReleaseVersionSelectObjectSchema.optional(),
    include: ReleaseVersionIncludeObjectSchema.optional(),
    where: ReleaseVersionWhereUniqueInputObjectSchema,
