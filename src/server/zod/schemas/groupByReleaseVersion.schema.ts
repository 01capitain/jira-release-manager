...
export const ReleaseVersionGroupBySchema: z.ZodType<Prisma.ReleaseVersionGroupByArgs> =
  z
    .object({
      ...
      orderBy: z
        .union([
          ReleaseVersionOrderByWithAggregationInputObjectSchema,
          ReleaseVersionOrderByWithAggregationInputObjectSchema.array(),
        ])
        .optional(),
      having:
        ReleaseVersionScalarWhereWithAggregatesInputObjectSchema.optional(),
      take: z.number().optional(),
      skip: z.number().optional(),
      by: z.array(ReleaseVersionScalarFieldEnumSchema),
      _count: z
    ...
    .strict() as unknown as z.ZodType<Prisma.ReleaseVersionGroupByArgs>;

export const ReleaseVersionGroupByZodSchema = z
  .object({
    where: ReleaseVersionWhereInputObjectSchema.optional(),
    orderBy: z
      .union([
