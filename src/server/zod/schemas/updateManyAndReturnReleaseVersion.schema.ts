...
export const ReleaseVersionUpdateManyAndReturnSchema = z.object({ select: ReleaseVersionSelectObjectSchema.optional(), data: ReleaseVersionUpdateManyMutationInputObjectSchema, where: ReleaseVersionWhereInputObjectSchema.optional()  }).strict()