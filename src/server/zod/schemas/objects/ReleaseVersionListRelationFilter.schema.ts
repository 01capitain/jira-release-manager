...
const makeSchema = () =>
  z
    ...
    .strict();
export const ReleaseVersionListRelationFilterObjectSchema: z.ZodType<Prisma.ReleaseVersionListRelationFilter> =
  makeSchema() as unknown as z.ZodType<Prisma.ReleaseVersionListRelationFilter>;
