...
const makeSchema = () => z.object({
  ...
  update: z.union([z.lazy(() => ReleaseVersionUpdateWithoutCreatedByInputObjectSchema), z.lazy(() => ReleaseVersionUncheckedUpdateWithoutCreatedByInputObjectSchema)]),
  create: z.union([z.lazy(() => ReleaseVersionCreateWithoutCreatedByInputObjectSchema), z.lazy(() => ReleaseVersionUncheckedCreateWithoutCreatedByInputObjectSchema)])
}).strict();
export const ReleaseVersionUpsertWithWhereUniqueWithoutCreatedByInputObjectSchema: z.ZodType<Prisma.ReleaseVersionUpsertWithWhereUniqueWithoutCreatedByInput> = makeSchema() as unknown as z.ZodType<Prisma.ReleaseVersionUpsertWithWhereUniqueWithoutCreatedByInput>;
export const ReleaseVersionUpsertWithWhereUniqueWithoutCreatedByInputObjectZodSchema = makeSchema();
