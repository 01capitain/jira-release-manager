...
const makeSchema = () =>
  z
    ...
    .strict();
export const ReleaseVersionCreateNestedManyWithoutCreatedByInputObjectSchema: z.ZodType<Prisma.ReleaseVersionCreateNestedManyWithoutCreatedByInput> =
  makeSchema() as unknown as z.ZodType<Prisma.ReleaseVersionCreateNestedManyWithoutCreatedByInput>;
export const ReleaseVersionCreateNestedManyWithoutCreatedByInputObjectZodSchema =
  makeSchema();
