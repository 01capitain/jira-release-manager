...
export const ReleaseVersionUpdateOneSchema = z.object({ select: ReleaseVersionSelectObjectSchema.optional(), include: ReleaseVersionIncludeObjectSchema.optional(), data: z.union([ReleaseVersionUpdateInputObjectSchema, ReleaseVersionUncheckedUpdateInputObjectSchema]), where: ReleaseVersionWhereUniqueInputObjectSchema  })